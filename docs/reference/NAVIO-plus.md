...
>
> For the underlying design system (raw tokens, component styling rules, do's & don'ts) see the companion [DESIGN_GUIDELINES.md](DESIGN_GUIDELINES.md). This spec is the *walkthrough*; that file is the *system*.
...
Full details in [DESIGN_GUIDELINES.md](DESIGN_GUIDELINES.md). Essentials to reproduce Navio Plus:
