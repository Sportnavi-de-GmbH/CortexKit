// V2 COPY — copied UNCHANGED from ../partner-recommendation-agent-supabase/lib/load-env.ts on 2026-09-14.
// V3 COPY — re-copied unchanged from ../partner-recommendation-agent-v2/lib/reused/load-env.ts on 2026-09-14.
